"""
NVIDIA IR Documents PDF Parse Pipeline
=======================================
...
# PDF directories to scan (all subdirs with PDFs)
PDF_SUBDIRS = [
    "01_Quarterly_Presentation",
    "02_CFO_Commentary",
    "03_Revenue_Trend",
    "04_Earnings_Transcript",
    "07_Non_GAAP_Historical",
]
...
# ============ Main Entry ============
def main():
    parser = argparse.ArgumentParser(description="NVIDIA IR PDF Parse Pipeline")
